...
1. <a class="github-button" href="https://github.com/fosslight/fosslight_yocto_scanner/fork" data-icon="octicon-repo-forked" aria-label="Fork fosslight/fosslight_source_scanner on GitHub">```Fork```</a> and clone the repository
