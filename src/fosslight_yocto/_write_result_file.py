...
def write_result_from_bom(out_file_name, installed_packages_src, installed_packages_bin, bin_android_mode=False, output_extension=""):
    sheet_list = {}
    list_src_to_print = []
    list_bin_to_print = []
    ...
    for scan_item in installed_packages_bin:
        list_bin_to_print.extend(scan_item.get_print_item(bin_android_mode))
